...
impl DbError {
    ...
    /// Defined as an inherent method (not `LdApiErrorInfo::to_public_message`) so that
    /// transparent delegate variants generated by `#[derive(LdApiError)]` pick it up
    /// through method-call resolution.
