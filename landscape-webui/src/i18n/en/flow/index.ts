export default {
  ...
  edit: {
    ...
    enabled: "Enabled",
    name: "Display Name",
    name_placeholder: "Optional; the remark is shown when left empty",
    remark: "Remark",
  ...
  trace: {
    ...
    mac_match: "MAC Match",
    ip_match: "IP Match",
    ipv4_match: "IPv4 Match",
    ipv6_match: "IPv6 Match",
    effective_flow: "Effective Flow",
    effective_flow_v4: "IPv4 Effective Flow",
    effective_flow_v6: "IPv6 Effective Flow",
    no_match: "No match",
