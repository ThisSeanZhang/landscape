...
pub fn init_xdp_wan_route(
    ...
    crate::bpf_ctx!(
        pin_and_reuse_map(&mut egress_intro_open_skel.maps.rt4_slot_map, &paths.rt4_slot_map,),
        "tc_wan_egress_intro pin rt4_slot_map"
    )?;
    crate::bpf_ctx!(
        pin_and_reuse_map(&mut egress_intro_open_skel.maps.rt6_slot_map, &paths.rt6_slot_map,),
        "tc_wan_egress_intro pin rt6_slot_map"
    )?;
    crate::bpf_ctx!(
